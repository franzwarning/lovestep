...
//	UInt32 onVelocity = 127;
    ...
    OSStatus result = noErr;
	require_noerr (result = MusicDeviceMIDIEvent (self.samplerUnit, noteCommand, (UInt32)note, (UInt32)velocity, 0), logTheError);
...
- (void)stopPlayingMidiNote:(NSInteger)note
{
    ...
    OSStatus result = noErr;
	require_noerr (result = MusicDeviceMIDIEvent (self.samplerUnit, noteCommand, (UInt32)note, 0, 0), logTheError);
